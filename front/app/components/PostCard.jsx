...
export default function PostCard({ heading, date, content, likes, id }) {
  const post_id = id;
  ...
  return (
    <Link href={`/post/${post_id}`}>
      <div
        className="rounded-2xl bg-[var(--card)] shadow p-4 flex flex-col gap-2 hover:shadow-xl transition"
        onClick={() => {
          console.log(post_id);
        }}
      >
