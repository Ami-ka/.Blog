    ...
    <div className="max-w-7xl mx-auto">
            ...
            <div className="flex-1 relative group">
              <div className="flex items-center bg-[#44435a] border border-[#44435a] rounded-2xl overflow-hidden transition-all duration-300 group-focus-within:border-[#b4499d]/50 group-focus-within:shadow-[0_0_20px_rgba(180,73,157,0.15)]">
                ...
                <button 
                  ...
                  className="group/search p-3 m-1 bg-gradient-to-r from-[#b4499d] to-[#f07e7f] rounded-xl transition-all duration-300 hover:shadow-[0_4px_15px_rgba(180,73,157,0.4)] hover:scale-105 active:scale-95"
                >
                  <Search 
                    size={18} 
      ...
      <div className="lg:hidden">
        ...
        <div className="flex items-center gap-2">
          ...
          {/* Search Input Mobile */}
          <div className="flex-1 relative group">
            <div className="flex items-center bg-[#44435a] border border-[#44435a] rounded-xl overflow-hidden transition-all duration-300 group-focus-within:border-[#b4499d]/50 group-focus-within:shadow-[0_0_20px_rgba(180,73,157,0.15)]">
              <input 
                className="flex-1 bg-transparent px-3 py-2 sm:py-2.5 text-white placeholder-gray-400 text-sm focus:outline-none"
                placeholder="Search..."
                type="text"
                value={searchValue}
                onChange={(e) => setSearchValue(e.target.value)}
